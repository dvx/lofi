...
// Native shadows are buggy, so just make a container that can hold the shadow as well
// On Mojave, we want to do away with the ugly white bar on top, so we simply move up the container window (way) past the top screen edge

    ...
    return (
      <div className='welcome full'>
        ...
        <div className="centered controls">
          <a className='login-btn not-draggable' target="auth" href="http://auth.lofi.rocks/login"><i className="fab fa-spotify not-draggable"></i>&nbsp;&nbsp;<span className="not-draggable">Log in</span></a>
        </div>
      </div>
    );
  }
